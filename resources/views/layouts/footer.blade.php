...
C318.858,289.466,324.212,407.178,495.426,413.249z" />
        ...
        <span class="text-xl">Bayah Beach</span>
			...
			<p class="mt-2 text-sm text-gray-500">Sawarna, Banten, Indonesia</p>
      <p class="mt-2 text-sm text-gray-500">Jelajahi Surga Tersembunyi di Pantai Banten dan Rasakan Keindahan Alam yang Memukau</p>
    </div>
